...
export function Navbar() {
  return (
    <div className="border-b sticky top-0 w-full z-[10000]">
      <header className="h-[calc(4rem-1px)] flex items-center justify-between max-w-screen-xl mx-auto border-x pl-4 pr-6 leading-none bg-white z-[100] relative">
        ...
        <div>
          <Button
            variant="secondary"
            className="bg-neutral-500 hover:bg-neutral-800/90 text-white px-1"
          >
            <div className="h-9 border-border/30 px-1.5 grid place-items-center border-r">
              <svg viewBox="0 0 438.549 438.549" aria-label="Github Stars">
